    	...
    	<br>
         <form name="form_descuento_registrar" id="form_update" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password"  autocomplete="new-password" onkeyup="validaPassword(this.value)">
                </div>
            </div>
